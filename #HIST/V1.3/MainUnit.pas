(*
  ...
  (c) Fight Club / Tyler Durden & Jack

  ClockWork v1.3 (c) 2001 D.J. NiKe
...
begin
  ...
  try
    ...
    mForm.Width := bg.Width;
    mForm.Height := bg.Height;
...
var h,w,i : integer;
begin
  h := mForm.Height; w := mForm.Width;
  bitblt(buf.Canvas.Handle,000,000,w,h,
...
{    if i in [1..6] then if mTimer.Enabled then continue;{}
  ...
  bitblt(mForm.Canvas.Handle,000,000,w,h,
